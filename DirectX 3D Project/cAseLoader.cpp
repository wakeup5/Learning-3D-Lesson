...
void cAseLoader::ProcessMESH_FACE_LIST( OUT std::vector<PNT_VERTEX>& vecVertex, IN std::vector<D3DXVECTOR3>& vecV )
{
	int nLevel = 0;
	do 
	{
...
void cAseLoader::ProcessMESH_TFACELIST( OUT std::vector<PNT_VERTEX>& vecVertex, IN std::vector<D3DXVECTOR2>& vecVT )
{
	int nLevel = 0;
	do 
	{
...
void cAseLoader::ProcessMESH_NORMALS( OUT std::vector<PNT_VERTEX>& vecVertex )
{
	int nLevel = 0;
	int nFaceIndex = 0;
